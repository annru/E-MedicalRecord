...
import priv.annru.emedicalrecord.fragment.MyCenterFragment;
import priv.annru.emedicalrecord.fragment.RemindFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragments.add(RemindFragment.getInstance());
        fragments.add(MyCenterFragment.getInstance());
